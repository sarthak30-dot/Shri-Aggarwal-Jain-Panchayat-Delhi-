    ...
    >
      <div
        ...
        style={{
          position: 'absolute',
          inset: 0,
          backgroundImage: `url(${heroTempleImage})`,
      ...
      <div
        style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(to bottom, rgba(23, 27, 33, 0.45) 0%, rgba(23, 27, 33, 0.65) 60%, rgba(23, 27, 33, 0.92) 100%)',
          zIndex: 1.5,
        }}
      />
      ...
      <div
        style={{
          position: 'absolute',
          inset: 0,
          background: 'radial-gradient(circle at center, hsla(28, 90%, 15%, 0.45) 0%, transparent 70%)',
